...
export default function OutfitDetailPage({ outfitId = 'the-modern-minimalist', onBack, onNavigateToCanvas, onOpenAuth, onAddToCart, isAuthenticated, onRequireAuth }) {
  const [selectedOutfitKey, setSelectedOutfitKey] = useState(outfitId);
  ...
  return <>
    <OutfitDetailPageDesktop {...viewProps} />
