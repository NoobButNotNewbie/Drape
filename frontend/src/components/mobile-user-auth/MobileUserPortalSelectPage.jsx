...
export default function MobileUserPortalSelectPage({
  onSelectPersonal,
  onSelectBrand,
  onBackToApp,
}) {
      ...
      <main className="py-6 flex-1 flex flex-col justify-center">
        ...
        <div className="space-y-4">
          ...
          <div
            ...
            className="bg-white rounded-2xl p-5 sm:p-6 border-2 border-[#1A3C24] shadow-md active:scale-[0.99] transition-all cursor-pointer group relative overflow-hidden"
          >
            <div className="absolute top-2 right-3 text-[9px] font-mono font-semibold uppercase bg-[#1A3C24] text-white px-2 py-0.5 rounded-full">
              Khách hàng
            </div>
            <div className="flex items-center justify-between mb-4">
              ...
              <ArrowRight className="w-5 h-5 text-[#1A3C24] group-hover:translate-x-1 transition-all" />
            </div>

            <h2 className="font-serif-luxury text-2xl font-semibold text-[#1A3C24] mb-2">
              For Personal
            </h2>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="w-11 h-11 rounded-xl bg-[#F0ECE1] text-[#6A675F] flex items-center justify-center group-hover:scale-105 transition-transform">
